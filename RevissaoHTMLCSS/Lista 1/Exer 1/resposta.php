<?php
 ...
 elseif ($valor_pago < $valor_total)
    $resultado = "Valor pago insuficiente!";
 else
    $resultado = "O troco é de: ".($valor_pago - $valor_total);
?>
...
<html lang="pt-br">
  ...
  <body class="container">
    <div id="box-valores">
      <h2 class="mt-5 display-6"><?php echo $resultado?></h2>
    </div>
